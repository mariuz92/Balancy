<template>
  ...
  >
    ...
    <!-- Navbar links -->
    <ul class="navbar-nav align-items-center ml-sm-auto xs-hidden">
      <li class="nav-item">
        <!-- nav-items -->
    ...
    <ul class="navbar-nav ml-sm-auto align-items-right">
      ...
      <base-dropdown
        ...
        class="nav-item d-xl-none d-md-none"
        tag="li"
        title-tag="a"
        title-classes="nav-link"
        icon="ni ni-ungroup"
      >
        <template>
          <div class="row shortcuts px-4">
            <a href="/calendar" class="col-4 shortcut-item">
              <span
            ...
            <a href="/tasks" class="col-4 shortcut-item">
              <span
